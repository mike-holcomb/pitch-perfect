...
************************************************/
    ...
    @IBAction func playSoundSlowly(sender: UIButton) {
        ...
        println("snail button pushed!")
    }
    @IBAction func playSoundFast(sender: UIButton) {
        playAudioWithRate(1.5)
        println("rabbit button pushed")
    }
    
    @IBAction func playSoundChipmunk(sender: UIButton) {
        playAudioWithVariablePitch(1000)
        println("chipmunk button pushed")
    }
    
    @IBAction func playSoundDarthVader(sender: UIButton) {
        playAudioWithVariablePitch(-1000)
        println("vader button pushed")
    }
    
    @IBAction func playSoundEcho(sender: UIButton) {
        println("echo button pushed")
        playAudioWithEffect(Effects.Echo,wetDryMix: 0.7)
    }
    
    @IBAction func playSoundReverb(sender: UIButton) {
        println("reverb button pushed")
        playAudioWithEffect(Effects.Reverb,wetDryMix: 0.7)
    }
    
    @IBAction func stopAudio(sender: UIButton) {
        stopAudioPlayback()
        println("pushed the stop button")
    }
